...
*   **Autenticación y Base de Datos:** [Firebase](https://firebase.google.com/) (Authentication, Firestore)
*   **Almacenamiento de Archivos:** [Supabase](https://supabase.io/) (Storage)
...
Crea un archivo llamado `.env.local` en la raíz del proyecto y añade tus credenciales de Firebase y Supabase.

```env
# Variables públicas para el cliente (Next.js)
...
# Variables secretas para el servidor
# (Obtenidas de la cuenta de servicio de Firebase Admin SDK)
FIREBASE_PROJECT_ID="TU_PROJECT_ID_DEL_JSON"
FIREBASE_CLIENT_EMAIL="TU_CLIENT_EMAIL_DEL_JSON"
FIREBASE_PRIVATE_KEY="-----BEGIN PRIVATE KEY-----\n...\n-----END PRIVATE KEY-----\n"

# (Obtenidas de la configuración de API de Supabase)
